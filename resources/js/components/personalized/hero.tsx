  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen text-center p-5'>
      ...
      <div className="relative h-full w-full flex items-center justify-center">
        ...
        <span className='absolute md:-top-20 bottom-0 transition-all duration-500'>
      ...
      <div className='flex items-center gap-1 md:mt-10 mt-52 transition-all duration-500'>
        Scroll To Explore
